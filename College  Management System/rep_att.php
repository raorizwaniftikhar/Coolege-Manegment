...
$query="SELECT s.Full_Name, s.RNUM as \"Roll #\", a.Daate as \"Date\" , l.Name as \"Course\" FROM attendance a JOIN students s ON a.SID = s.SID JOIN lectures l ON a.LRID = l.LID WHERE a.LRID = $ARG1";
...
$title= "Attendance"; 	// Title to be displayed on the Report
