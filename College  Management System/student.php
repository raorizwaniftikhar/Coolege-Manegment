...
$_SESSION['SID']= $row_Student_Info['SID'];
...
<map name="Menu_Map" id="Menu_Map"><area shape="rect" coords="26,7,125,38" href="student.php" />
<area shape="rect" coords="142,8,223,38" href="about.php" alt="" />
<area shape="rect" coords="251,7,326,41" href="help.php" alt="" />
					...
					<div class="content_corner_right">
						<div class="bg_right_content">
							<div class="indent_content">
								<p>
								  <!--left_col-->
							      <span class="extra_left">Welcome </span><span class="text_1"><?php echo $row_Student_Info['Full_Name']; ?></span><span class="extra_left"> Roll Number : </span><span class="text_1"><?php echo $row_Student_Info['RNUM']; ?></span><span class="extra_left"> Class : </span><span class="text_1"><?php echo $row_Student_Info['CID']; ?></span> </p>
								<div align="center"></div>
								<div>
									<div class="extra_left"><br />
      ...
      <td width="757" height="179" background="imgs/cou.jpg"><table width="757" height="149" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td height="63"><table width="134" height="48" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="67">&nbsp;</td>
              <td width="67" valign="bottom"><span class="style1 style8">1</span></td>
            </tr>
          </table></td>
          <td colspan="4"><a href="subject.php?L=<?php echo $row_Lecture1['LID']; ?>" class="link"><?php echo $row_Lecture1['Name']; ?></a></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td colspan="2">&nbsp;</td>
          <td colspan="2" valign="middle"><?php echo $row_Teacher1['Full_Name']; ?></td>
          <td>&nbsp;</td>
        </tr>
      </table></td>
    </tr>
      ...
      <td width="757" height="179" background="imgs/cou.jpg"><table width="757" height="149" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td height="63"><table width="134" height="48" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="67">&nbsp;</td>
              <td width="67" valign="bottom"><span class="style1 style8">2</span></td>
            </tr>
            </table></td>
          <td colspan="4"><a href="subject.php?L=<?php echo $row_Lecture2['LID']; ?>" class="link"><?php echo $row_Lecture2['Name']; ?></a></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td colspan="2">&nbsp;</td>
          <td colspan="2" valign="middle"><?php echo $row_Teacher2['Full_Name']; ?></td>
          <td>&nbsp;</td>
        </tr>
      </table></td>
    </tr>
        ...
        <td width="757" height="179" background="imgs/cou.jpg"><table width="757" height="149" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td height="63"><table width="134" height="48" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="67">&nbsp;</td>
                    <td width="67" valign="bottom"><span class="style1 style8">3</span></td>
                  </tr>
              </table></td>
              <td colspan="4"><a href="subject.php?L=<?php echo $row_Lecture3['LID']; ?>" class="link"><?php echo $row_Lecture3['Name']; ?></a></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td colspan="2">&nbsp;</td>
              <td colspan="2" valign="middle"><?php echo $row_Teacher3['Full_Name']; ?></td>
              <td>&nbsp;</td>
            </tr>
        </table></td>
      </tr>
        ...
        <td width="757" height="179" background="imgs/cou.jpg"><table width="757" height="149" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td height="63"><table width="134" height="48" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="67">&nbsp;</td>
                    <td width="67" valign="bottom"><span class="style1 style8">4</span></td>
                  </tr>
              </table></td>
              <td colspan="4"><a href="subject.php?L=<?php echo $row_Lecture4['LID']; ?>" class="link"><?php echo $row_Lecture4['Name']; ?></a></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td colspan="2">&nbsp;</td>
              <td colspan="2" valign="middle"><?php echo $row_Teacher4['Full_Name']; ?></td>
              <td>&nbsp;</td>
            </tr>
        </table></td>
      </tr>
        ...
        <td width="757" height="179" background="imgs/cou.jpg"><table width="757" height="149" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td height="63"><table width="134" height="48" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="67">&nbsp;</td>
                    <td width="67" valign="bottom"><span class="style1 style8">5</span></td>
                  </tr>
              </table></td>
              <td colspan="4"><a href="subject.php?L=<?php echo $row_Lecture5['LID']; ?>" class="link"><?php echo $row_Lecture5['Name']; ?></a></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
        ...
        <td width="757" height="179" background="imgs/cou.jpg"><table width="757" height="149" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td height="63"><table width="134" height="48" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="67">&nbsp;</td>
                    <td width="67" valign="bottom"><span class="style1 style8">6</span></td>
                  </tr>
              </table></td>
              <td colspan="4"><a href="subject.php?L=<?php echo $row_Lecture6['LID']; ?>" class="link"><?php echo $row_Lecture6['Name']; ?></a></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td colspan="2">&nbsp;</td>
              <td colspan="2" valign="middle"><?php echo $row_Teacher6['Full_Name']; ?></td>
              <td>&nbsp;</td>
            </tr>
        </table></td>
      </tr>
        ...
        <td width="757" height="179" background="imgs/cou.jpg"><table width="757" height="149" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td height="63"><table width="134" height="48" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="67">&nbsp;</td>
              <td width="67" valign="bottom"><span class="style1 style8">7</span></td>
            </tr>
            </table></td>
          <td colspan="4"><a href="subject.php?L=<?php echo $row_Lecture7['LID']; ?>" class="link"><?php echo $row_Lecture7['Name']; ?></a></td>
          <td>&nbsp;</td>
        </tr>
          <tr>
            <td>&nbsp;</td>
          <td colspan="2">&nbsp;</td>
          <td colspan="2" valign="middle"><?php echo $row_Teacher7['Full_Name']; ?></td>
          <td>&nbsp;</td>
        </tr>
        </table></td>
    </tr>
