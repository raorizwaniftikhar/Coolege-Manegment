...
<div class="site_center">
	...
	<div class="menu">
		<div class="bg_menu">
		    ...
		    <map name="Map" id="Map">
		      <area shape="rect" coords="27,11,128,36" href="iteacher.php" alt="" />
		      <area shape="rect" coords="144,8,226,36" href="aboutt.php" alt="" />
						...
						<div class="bg_right_content">
							<div class="indent_content">
								...
								<div class="col_1">
								  <div class="extra_left">
								    ...
								    <table width="574" border="0">
                                      <tr>
                                        <td class="button_2">&nbsp;&nbsp;<span class="style2">Help And Contacts</span></td>
                                      </tr>
                                      <tr>
                                        <td>&nbsp;</td>
                                      </tr>
                                      <tr>
                                        <td><p>IF you face any problem regarding to your accout then please contact at this mobile no..</p>
                                        <p>ph# 0321-3590102 </p>
                                        <p>Email: kashif_ashfaq@yahoo.com </p></td>
                                      </tr>
                                      <tr>
                                        <td>&nbsp;</td>
                                      </tr>
								...
								<div class="col_2 ind_top_col">
                                  ...
                                  <div class="footer">OCMS@2009 </div>
                              </div>
							</div>
						</div>
					</div>
