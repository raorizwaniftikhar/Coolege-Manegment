...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO assignments (Type, File, Against, SID) VALUES (%s, %s, %s, %s)",
	...
	<div class="menu">
		<div class="bg_menu"><img src="images/1page_bg_menu.jpg" alt=" " width="469" height="106" usemap="#Menu_Map" />
		  <map name="Menu_Map" id="Menu_Map">
		    <area shape="rect" coords="26,7,125,38" href="student.php" />
							...
							<div class="indent_content">
								...
								<div class="col_1">
								  <div class="extra_left">
								    <p>Course Name : <span class="text"><?php echo $row_Subject_Info['Name']; ?><br />
								    </span></p>
							        <table width="538" border="0" cellspacing="0" cellpadding="0">
						              ...
						              <table width="539" height="70" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                          <td class="style2">Subject Announcements </td>
                                        </tr>
                                        <tr>
                                          ...
                                          <tr>
                                            <td><?php do { ?>
                                                      <table width="524" border="0" align="center" cellpadding="0" cellspacing="0">
                                                        ...
                                                        <tr>
                                                          <td class="text"><form name="form1" action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" id="Upload">
Upload :
    <input type="file" name="file" />
    <input type="submit" name="Submit" value="Upload" />
    <input name="AID" type="hidden" id="AID" value="<?php echo $row_Assignments['AID']; ?>" />
...
<input type="hidden" name="MM_insert" value="form1">
                                ...
                                <div class="col_2 ind_top_col">
                                   ...
                                   <div class="footer">
                                     <div align="center">OCMS&copy; 2009 </div>
                                   </div>
                                </div>
							</div>
						</div>
