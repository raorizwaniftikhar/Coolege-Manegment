...
$xt = new Xtempl();
$body=array();
$body["begin"]="<FORM name=frmimport id=frmimport action=\"lectures_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='lectures_list.php?a=return';\"");
$xt->assign("error_message",$error_message);
$xt->display("lectures_import.htm");
