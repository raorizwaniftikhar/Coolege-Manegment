...
//	RNUM - 
			$value="";
				$value = ProcessLargeText(GetData($data,"RNUM", ""),"field=RNUM".$keylink);
			$xt->assign("RNUM_mastervalue",$value);

//	Full_Name - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Full_Name", ""),"field=Full%5FName".$keylink);
...
//	L7 - 
	...
	$strTableName=$oldTableName;
	$xt->display("students_masterlist.htm");
}
