...
//	Title - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Title", ""),"field=Title".$keylink);
...
//	Marks - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Marks", ""),"field=Marks".$keylink);
			$xt->assign("Marks_mastervalue",$value);

//	Description - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Description", ""),"field=Description".$keylink);
...
//	File - Document Download
	...
	$strTableName=$oldTableName;
	$xt->display("assignments_masterlist.htm");
}
