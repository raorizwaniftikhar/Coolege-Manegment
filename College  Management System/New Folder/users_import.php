...
$xt = new Xtempl();
$body=array();
$body["begin"]="<FORM name=frmimport id=frmimport action=\"users_import.php\" method=post encType=multipart/form-data >".
...
$xt->assign("backtolist_attrs","onclick=\"javascript: window.location='users_list.php?a=return';\"");
$xt->assign("error_message",$error_message);
$xt->display("users_import.htm");
