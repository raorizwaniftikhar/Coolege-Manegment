...
include("include/students_variables.php");
	include("include/classes_settings.php");
...
{	
	...
	if($lookuptable=="attendance" && $lookupfield=="SID") 
	{
		$linkfield = "SID";
		$dispfield = "Full_Name";
			}
	if($lookuptable=="marks" && $lookupfield=="SID") 
	{
		$linkfield = "SID";
		$dispfield = "Full_Name";
			}
...
//	this code must be executed after the inlineedit.js is loaded
	...
	$code_end.='
		window.inlineEditing'.$id.' = new InlineEditing(\'students\',\'php\','.$id.');
		'.$afteredited_handler;
...
{
	$includes_js[]="include/inlineedit.js";
	$code_end .= 'window.inlineEditing'.$id.' = new InlineEditing(\'students\',\'php\');';
}
...
//	validation stuff
	...
	$addValidateFields = array();
			...
			$editValidateFields[] = "CID";
					...
					$validatetype.="IsRequired";
			$editValidateTypes[] = $validatetype;
			$editValidateFields[] = "RNUM";
										$validatetype="";
					$validatetype.="IsRequired";
			$editValidateTypes[] = $validatetype;
			$editValidateFields[] = "Full_Name";
										$validatetype="";
					$validatetype.="IsRequired";
			$editValidateTypes[] = $validatetype;
			$editValidateFields[] = "Status";
					...
					$validatetype.="IsRequired";
			$editValidateTypes[] = $validatetype;
			$editValidateFields[] = "L1";
			$editValidateTypes[] = "";
		$editValidateFields[] = "L2";
			$editValidateTypes[] = "";
		$editValidateFields[] = "L3";
			$editValidateTypes[] = "";
		$editValidateFields[] = "L4";
			$editValidateTypes[] = "";
		$editValidateFields[] = "L5";
			$editValidateTypes[] = "";
		$editValidateFields[] = "L6";
			$editValidateTypes[] = "";
		$editValidateFields[] = "L7";
			...
			$addValidateFields[] = "CID";
					...
					$validatetype.="IsRequired";
			$addValidateTypes[] = $validatetype;
			$addValidateFields[] = "RNUM";
										$validatetype="";
					$validatetype.="IsRequired";
			$addValidateTypes[] = $validatetype;
			$addValidateFields[] = "Full_Name";
										$validatetype="";
					$validatetype.="IsRequired";
			$addValidateTypes[] = $validatetype;
			$addValidateFields[] = "Status";
					...
					$validatetype.="IsRequired";
			$addValidateTypes[] = $validatetype;
			$addValidateFields[] = "L1";
			$addValidateTypes[] = "";
		$addValidateFields[] = "L2";
			$addValidateTypes[] = "";
		$addValidateFields[] = "L3";
			$addValidateTypes[] = "";
		$addValidateFields[] = "L4";
			$addValidateTypes[] = "";
		$addValidateFields[] = "L5";
			$addValidateTypes[] = "";
		$addValidateFields[] = "L6";
			$addValidateTypes[] = "";
		$addValidateFields[] = "L7";
...
"\nvar bLoading=false;\r\n";
	$code_begin.="var SUGGEST_TABLE='students_searchsuggest.php';\r\n";
	$code_begin.="var MASTER_PREVIEW_TABLE='students_masterpreview.php';\r\n";
...
$body = array();
if($mode==LIST_SIMPLE)
	$html_begin.="<form name=\"frmSearch\" method=\"GET\" action=\"students_list.php\">";
else
{
	$html_begin.="<form name=\"frmSearch".$id."\" target=\"flyframe".$id."\" method=\"GET\" action=\"students_list.php\">";
...
$href="students_list.php?orderby=aCID";
$orderlinkattrs="";
if($mode==LIST_LOOKUP)
{
	$href.="&".$lookupparams;
...
$href="students_list.php?orderby=aRNUM";
$orderlinkattrs="";
if($mode==LIST_LOOKUP)
{
	$href.="&".$lookupparams;
...
$orderlinkattrs.=" href=\"".$href."\"";
$xt->assign("RNUM_orderlinkattrs",$orderlinkattrs);
$xt->assign("RNUM_fieldheader",true);
$href="students_list.php?orderby=aFull_Name";
$orderlinkattrs="";
if($mode==LIST_LOOKUP)
{
	$href.="&".$lookupparams;
...
$orderlinkattrs.=" href=\"".$href."\"";
$xt->assign("Full_Name_orderlinkattrs",$orderlinkattrs);
$xt->assign("Full_Name_fieldheader",true);
$href="students_list.php?orderby=aStatus";
$orderlinkattrs="";
if($mode==LIST_LOOKUP)
{
	$href.="&".$lookupparams;
...
$orderlinkattrs.=" href=\"".$href."\"";
$xt->assign("Status_orderlinkattrs",$orderlinkattrs);
$xt->assign("Status_fieldheader",true);
$href="students_list.php?orderby=aL1";
$orderlinkattrs="";
if($mode==LIST_LOOKUP)
{
	$href.="&".$lookupparams;
...
$orderlinkattrs.=" href=\"".$href."\"";
$xt->assign("L1_orderlinkattrs",$orderlinkattrs);
$xt->assign("L1_fieldheader",true);
$href="students_list.php?orderby=aL2";
$orderlinkattrs="";
if($mode==LIST_LOOKUP)
{
	$href.="&".$lookupparams;
...
$orderlinkattrs.=" href=\"".$href."\"";
$xt->assign("L2_orderlinkattrs",$orderlinkattrs);
$xt->assign("L2_fieldheader",true);
$href="students_list.php?orderby=aL3";
$orderlinkattrs="";
if($mode==LIST_LOOKUP)
{
	$href.="&".$lookupparams;
...
$orderlinkattrs.=" href=\"".$href."\"";
$xt->assign("L3_orderlinkattrs",$orderlinkattrs);
$xt->assign("L3_fieldheader",true);
$href="students_list.php?orderby=aL4";
$orderlinkattrs="";
if($mode==LIST_LOOKUP)
{
	$href.="&".$lookupparams;
...
$orderlinkattrs.=" href=\"".$href."\"";
$xt->assign("L4_orderlinkattrs",$orderlinkattrs);
$xt->assign("L4_fieldheader",true);
$href="students_list.php?orderby=aL5";
$orderlinkattrs="";
if($mode==LIST_LOOKUP)
{
	$href.="&".$lookupparams;
...
$orderlinkattrs.=" href=\"".$href."\"";
$xt->assign("L5_orderlinkattrs",$orderlinkattrs);
$xt->assign("L5_fieldheader",true);
$href="students_list.php?orderby=aL6";
$orderlinkattrs="";
if($mode==LIST_LOOKUP)
{
	$href.="&".$lookupparams;
...
$orderlinkattrs.=" href=\"".$href."\"";
$xt->assign("L6_orderlinkattrs",$orderlinkattrs);
$xt->assign("L6_fieldheader",true);
$href="students_list.php?orderby=aL7";
$orderlinkattrs="";
if($mode==LIST_LOOKUP)
{
	$href.="&".$lookupparams;
...
$orderlinkattrs.=" href=\"".$href."\"";
$xt->assign("L7_orderlinkattrs",$orderlinkattrs);
...
if(@$_SESSION[$strTableName."_orderby"])
{
	...
	$href="students_list.php?orderby=".$dir.GoodFieldName($order_field);
	$orderlinkattrs="";
	if($mode==LIST_LOOKUP)
	{
		$href.="&".$lookupparams;
...
{  
	...
	else
	{
		...
		if($where=StrWhere("CID", $strSearchFor, $strSearchOption, ""))
			$strWhere .= " or ".$where;
		if($where=StrWhere("RNUM", $strSearchFor, $strSearchOption, ""))
			$strWhere .= " or ".$where;
		if($where=StrWhere("Full_Name", $strSearchFor, $strSearchOption, ""))
			$strWhere .= " or ".$where;
		if($where=StrWhere("UID", $strSearchFor, $strSearchOption, ""))
			$strWhere .= " or ".$where;
		if($where=StrWhere("Status", $strSearchFor, $strSearchOption, ""))
			$strWhere .= " or ".$where;
		if($where=StrWhere("L1", $strSearchFor, $strSearchOption, ""))
			$strWhere .= " or ".$where;
		if($where=StrWhere("L2", $strSearchFor, $strSearchOption, ""))
			$strWhere .= " or ".$where;
		if($where=StrWhere("L3", $strSearchFor, $strSearchOption, ""))
			$strWhere .= " or ".$where;
		if($where=StrWhere("L4", $strSearchFor, $strSearchOption, ""))
			$strWhere .= " or ".$where;
		if($where=StrWhere("L5", $strSearchFor, $strSearchOption, ""))
			$strWhere .= " or ".$where;
		if($where=StrWhere("L6", $strSearchFor, $strSearchOption, ""))
			$strWhere .= " or ".$where;
		if($where=StrWhere("L7", $strSearchFor, $strSearchOption, ""))
			$strWhere .= " or ".$where;
...
if($allow_search)
{
	...
	foreach($masterkeys as $idx=>$val)
	{
		if($masterwhere)
			$masterwhere.=" and ";
			$strOriginalDetailsTable="classes";
	...
	$countsql = "select count(*) from ".AddTableWrappers($strOriginalDetailsTable)." where ".$sqlWhere;
		$gsqlHead.=",(".$countsql.") as classes_cnt ";
	}
	$strSQLbak = $strSQL;
	...
	if($maxpages>1)
	{
		...
		if($mode==LIST_SIMPLE)
			$code_end.="window.GotoPage = function(nPageNumber)
				{
					window.location='students_list.php?goto='+nPageNumber;
				};";
		else
			$code_end.="window.GotoPage".$id." = function (nPageNumber)
				{
					window.frames['flyframe".$id."'].location='students_list.php?".$lookupparams."&goto='+nPageNumber;
				};";
...
//	detail tables
			...
			$detailid[]=make_db_value("CID",$data["CID"],"","","classes");
	//	add count of child records to SQL
		if(!$bSubqueriesSupported)
	{
	$sqlHead="SELECT CID,   `Session`,   Semester,   Subjects ";
	$sqlFrom="FROM classes ";
	$sqlWhere="";
	$sqlTail="";
	$masterkeys=array();
	$masterkeys[]="`CID`";
	...
	foreach($masterkeys as $idx=>$val)
	{
		if($masterwhere)
			$masterwhere.=" and ";
	$masterwhere.=GetFullFieldName($detailkeys[$idx],"classes")."=".$detailid[$idx];
	}
	$data["classes_cnt"]=gSQLRowCount_int($sqlHead,$sqlFrom,$sqlWhere,$sqlTail,$masterwhere,0);
	}

//detail tables
	$record["classes_dtable_link"]=$allow_classes;
	$record["classes_dtablelink_attrs"]="href=\"classes_list.php?".$masterquery."\" id=\"master_classes".$recid."\"";
	$dpreview=true;
			if(!($data["classes_cnt"]+0))
	{
		$record["classes_dtable_link"]=false;
		$dpreview=false;
	}
	if($dpreview)
	{
			$record["classes_dtablelink_attrs"].=" onmouseover=\"RollDetailsLink.showPopup(this,'classes_detailspreview.php'+this.href.substr(this.href.indexOf('?')));\" onmouseout=\"RollDetailsLink.hidePopup();\"";
		}
...
//	key fields
	...
	$copylink="";
	$keylink="";
	$keyblock.= rawurlencode($data["SID"]);
	$editlink.="editid1=".htmlspecialchars(rawurlencode($data["SID"]));
	$copylink.="copyid1=".htmlspecialchars(rawurlencode($data["SID"]));
	$keylink.="&key1=".htmlspecialchars(rawurlencode(@$data["SID"]));

	$record["editlink_attrs"]="href=\"students_edit.php?".$editlink."\" id=\"editlink".$recid."\"";
	$record["inlineeditlink_attrs"]= "href=\"students_edit.php?".$editlink."\" onclick=\"return inlineEditing".$id.".inlineEdit('".$recid."','".$editlink."');\" id=\"ieditlink".$recid."\"";
	$record["copylink_attrs"]="href=\"students_add.php?".$copylink."\" id=\"copylink".$recid."\"";
	$record["viewlink_attrs"]="href=\"students_view.php?".$editlink."\" id=\"viewlink".$recid."\"";
	if($mode!=LIST_LOOKUP)
	{
...
//	RNUM - 
			$value="";
				$value = ProcessLargeText(GetData($data,"RNUM", ""),"field=RNUM".$keylink,"",MODE_LIST);
			$record["RNUM_value"]=$value;

//	Full_Name - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Full_Name", ""),"field=Full%5FName".$keylink,"",MODE_LIST);
...
//	L7 - 
			...
			$span="<span ";
			$span.="id=\"edit".$recid."_RNUM\" ";
					$span.="val=\"".htmlspecialchars($data["RNUM"])."\" ";
			$span.=">";
			$record["RNUM_value"] = $span.$record["RNUM_value"]."</span>";
			$span="<span ";
			$span.="id=\"edit".$recid."_Full_Name\" ";
					$span.="val=\"".htmlspecialchars($data["Full_Name"])."\" ";
			$span.=">";
			$record["Full_Name_value"] = $span.$record["Full_Name_value"]."</span>";
			$span="<span ";
			$span.="id=\"edit".$recid."_Status\" ";
					$span.="val=\"".htmlspecialchars($data["Status"])."\" ";
			$span.=">";
			$record["Status_value"] = $span.$record["Status_value"]."</span>";
			$span="<span ";
			$span.="id=\"edit".$recid."_L1\" ";
					$span.="val=\"".htmlspecialchars($data["L1"])."\" ";
			$span.=">";
			$record["L1_value"] = $span.$record["L1_value"]."</span>";
			$span="<span ";
			$span.="id=\"edit".$recid."_L2\" ";
					$span.="val=\"".htmlspecialchars($data["L2"])."\" ";
			$span.=">";
			$record["L2_value"] = $span.$record["L2_value"]."</span>";
			$span="<span ";
			$span.="id=\"edit".$recid."_L3\" ";
					$span.="val=\"".htmlspecialchars($data["L3"])."\" ";
			$span.=">";
			$record["L3_value"] = $span.$record["L3_value"]."</span>";
			$span="<span ";
			$span.="id=\"edit".$recid."_L4\" ";
					$span.="val=\"".htmlspecialchars($data["L4"])."\" ";
			$span.=">";
			$record["L4_value"] = $span.$record["L4_value"]."</span>";
			$span="<span ";
			$span.="id=\"edit".$recid."_L5\" ";
					$span.="val=\"".htmlspecialchars($data["L5"])."\" ";
			$span.=">";
			$record["L5_value"] = $span.$record["L5_value"]."</span>";
			$span="<span ";
			$span.="id=\"edit".$recid."_L6\" ";
					$span.="val=\"".htmlspecialchars($data["L6"])."\" ";
			$span.=">";
			$record["L6_value"] = $span.$record["L6_value"]."</span>";
			$span="<span ";
			$span.="id=\"edit".$recid."_L7\" ";
					$span.="val=\"".htmlspecialchars($data["L7"])."\" ";
			$span.=">";
			$record["L7_value"] = $span.$record["L7_value"]."</span>";
...
if($mode==LIST_SIMPLE)
{
	...
	$xt->assign("printlink_attrs","href=\"students_print.php\" onclick=\"window.open('students_print.php','wPrint');return false;\"");
	$xt->assign("printalllink_attrs","href=\"students_print.php?all=1\" onclick=\"window.open('students_print.php?all=1','wPrint');return false;\"");
	$xt->assign("export_link",$allow_export);
	$xt->assign("exportlink_attrs","href=\"students_export.php\" onclick=\"window.open('students_export.php','wExport');return false;\"");
	...
	if(!\$('input[@type=checkbox][@checked][@name^=selection]').length)
		return true;
	document.forms.frmAdmin.action='students_print.php';
	document.forms.frmAdmin.target='_blank';
	document.forms.frmAdmin.submit(); 
	document.forms.frmAdmin.action='students_list.php'; 
	document.forms.frmAdmin.target='_self';return false\"
	href=\"students_print.php\"");
	$xt->assign("exportselected_link",$allow_export);
	$xt->assign("exportselectedlink_attrs","disptype=\"control1\" onclick=\"
	if(!\$('input[@type=checkbox][@checked][@name^=selection]').length)
		return true;
	document.forms.frmAdmin.action='students_export.php';
	document.forms.frmAdmin.target='_blank';
	document.forms.frmAdmin.submit(); 
	document.forms.frmAdmin.action='students_list.php'; 
	document.forms.frmAdmin.target='_self';return false;\"
	href=\"students_export.php\"");
	
	$xt->assign("add_link",$allow_add);
	$xt->assign("copy_column",$allow_add);
	$xt->assign("addlink_attrs","href=\"students_add.php\" onClick=\"window.location.href='students_add.php'\"");
	$xt->assign("inlineadd_link",$allow_add);
	$xt->assign("inlineaddlink_attrs","href=\"students_add.php\" onclick=\"return inlineEditing".$id.".inlineAdd(flyid++,null,'students_add.php');\"");
...
for (i=0;i<frmAdmin.elements['selection[]'].length;++i) 
	...
	$xt->assign("editselectedlink_attrs","href=\"students_edit.php\" disptype=\"control1\" name=\"edit_selected".$id."\" onclick=\"\$('input[@type=checkbox][@checked][@id^=check]').each(function(i){
	...
	if($mode!=LIST_LOOKUP)
	{
 		$xt->assign("classes_dtable_column",$allow_classes);
	}
...
//	$xt->assign("checkbox_column",true);
	$xt->assign("inlineadd_link",$allow_add);
	$xt->assign("inlineaddlink_attrs","href=\"students_add.php\" onclick=\"return inlineEditing".$id.".inlineAdd(flyid++,".$id.",'students_add.php');\"");
//	$xt->assign("inlineedit_column",$allow_edit);
}
...
$xt->assign("asearchlink_attrs","href=\"students_search.php\" onclick=\"window.location.href='students_search.php';return false;\"");
$xt->assign("import_link",$allow_import);
$xt->assign("importlink_attrs","href=\"students_import.php\" onclick=\"window.location.href='students_import.php';return false;\"");
...
if($display_grid)
{
	if($mode==LIST_SIMPLE)
		...
		"<form method=\"POST\" action=\"students_list.php\" name=\"frmAdmin\" id=\"frmAdmin\">
		<input type=\"hidden\" id=\"a\" name=\"a\" value=\"delete\">",
		"</form>");
	elseif($mode==LIST_LOOKUP)
		$xt->assign_section("grid_block",
		"<form method=\"POST\" action=\"students_list.php\" name=\"frmAdmin".$id."\" id=\"frmAdmin".$id."\" target=\"flyframe".$id."\">
...
if($mode==LIST_SIMPLE)
{
	...
	$xt->assign("recordspp_attrs","onchange=\"javascript: document.location='students_list.php?pagesize='+this.options[this.selectedIndex].value;\"");
	$xt->assign("pages_block",$allow_search && $rowsfound);
}
else
	$xt->assign("recordspp_attrs","onchange=\"javascript: window.frames['flyframe".$id."'].location='students_list.php?".$lookupparams."&pagesize='+this.options[this.selectedIndex].value;\"");
...
if($mastertable=="users")
{
	...
	$xt->assign("backtomasterlink_attrs","href=\"users_list.php?a=return\"");
}
if($mastertable=="marks")
{
	$xt->assign("mastertable_block",true);
...
$templatefile = "students_list.htm";
