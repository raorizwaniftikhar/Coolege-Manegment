...
if (isset($_GET['searchFor']) && postvalue('searchFor') != '') {
			...
			if ( $searchField == '' || $searchField=="CID")
	{
		...
		$rs=db_query($strSQL,$conn);
			...
			if ( $searchField == '' || $searchField=="TID")
	{
		$field="TID";
		if(CheckFieldPermissions($field))
		{
			...
			if ( $searchField == '' || $searchField=="Name")
	{
		...
		$rs=db_query($strSQL,$conn);
			...
			if ( $searchField == '' || $searchField=="Continue")
	{
		$field="Continue";
		if(CheckFieldPermissions($field))
		{
		...
		$rs=db_query($strSQL,$conn);
			...
			if ( $searchField == '' || $searchField=="Type")
	{
		$field="Type";
		if(CheckFieldPermissions($field))
		{
		...
		$rs=db_query($strSQL,$conn);
			...
			while ($row = db_fetch_numarray($rs)) {
				...
				if ($pos!==FALSE) {
					...
					if ( $searchField == '' || $searchField=="Time")
	{
		$field="Time";
		if(CheckFieldPermissions($field))
		{
			...
			if ( $searchField == '' || $searchField=="Room")
	{
		...
		$rs=db_query($strSQL,$conn);
			...
			if ( $searchField == '' || $searchField=="Duration")
	{
		$field="Duration";
		if(CheckFieldPermissions($field))
		{
		...
		$rs=db_query($strSQL,$conn);
			...
			if ( $searchField == '' || $searchField=="About")
	{
		$field="About";
		if(CheckFieldPermissions($field))
		{
		...
		$rs=db_query($strSQL,$conn);
			...
			if ( $searchField == '' || $searchField=="Announce")
	{
		$field="Announce";
		if(CheckFieldPermissions($field))
		{
