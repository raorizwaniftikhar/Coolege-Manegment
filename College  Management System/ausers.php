...
$query_Students = "SELECT * FROM users ORDER BY Type ASC";
      ...
      <tr>
        ...
        <td width="757" valign="top"><br />          &nbsp;&nbsp;Welcome <br />
          ...
          <table width="680" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td bgcolor="#A8CC45"> <span class="style1">&nbsp;&nbsp;Users</span></td>
            </tr>
            <tr>
              <td height="74" valign="top"><div align="center"><br />
                Total User : <?php echo $totalRows_Students ?> </div>
                <br />
                <?php do { ?>
                  <table width="636" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="123"><div align="center"><?php echo $row_Students['ID']; ?></div></td>
                        <td width="294"><?php echo $row_Students['UID']; ?></td>
                        <td width="161"><select name="select" disabled="disabled">
                          <option value="1" <?php if (!(strcmp(1, $row_Students['Type']))) {echo "selected=\"selected\"";} ?>>Student</option>
                          <option value="2" <?php if (!(strcmp(2, $row_Students['Type']))) {echo "selected=\"selected\"";} ?>>Teacher</option><option value="0" <?php if (!(strcmp(0, $row_Students['Type']))) {echo "selected=\"selected\"";} ?>>Admin</option>
                        </select></td>
                        <td width="58"><a href="del_user.php?id=<?php echo $row_Students['ID']; ?>" class="style2">Delete</a></td>
                      </tr>
                                      </table>
