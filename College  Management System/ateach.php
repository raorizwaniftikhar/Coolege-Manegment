...
$query_Students = "SELECT * FROM teachers";
      ...
      <tr>
        ...
        <td width="757" valign="top"><br />          &nbsp;&nbsp;Welcome <br />
          ...
          <table width="680" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td bgcolor="#A8CC45"> <span class="style1">&nbsp;&nbsp;Teachers</span></td>
            </tr>
            <tr>
              <td height="74" valign="top"><div align="center"><br />
                Total Teachers : <?php echo $totalRows_Students ?> </div>
                <br />
                <?php do { ?>
                  <table width="636" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="123"><div align="center"><?php echo $row_Students['TID']; ?></div></td>
                        <td width="455"><?php echo $row_Students['Full_Name']; ?></td>
                        <td width="58"><a href="del_teach.php?id=<?php echo $row_Students['UID']; ?>" class="style2">Delete</a></td>
                      </tr>
                      </table>
