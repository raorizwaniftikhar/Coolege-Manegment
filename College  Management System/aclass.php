...
$colname_Students = "-1";
if (isset($_POST['class'])) {
  $colname_Students = (get_magic_quotes_gpc()) ? $_POST['class'] : addslashes($_POST['class']);
}
      ...
      <tr>
        ...
        <td width="757" valign="top"><br />          &nbsp;&nbsp;Welcome <br />
          ...
          <table width="680" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td bgcolor="#A8CC45"> <span class="style1">&nbsp;&nbsp;Students of <?php echo $_POST['class']; ?></span></td>
            </tr>
            <tr>
              <td height="74" valign="top"><div align="center"><br />
                Total Students in Class : <?php echo $totalRows_Students ?> </div>
                <br />
                <?php do { ?>
                  <table width="636" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="134"><div align="center"><?php echo $row_Students['RNUM']; ?></div></td>
                        <td width="441"><?php echo $row_Students['Full_Name']; ?></td>
                        <td width="61"><a href="del_stu.php?id=<?php echo $row_Students['UID']; ?>" class="style2">Delete</a></td>
                      </tr>
                      </table>
